...
public class showController {
    ...
    HashMap<String, List> kmap = new HashMap<String, List>() {{
		...
		put("数据结构", new ArrayList<Integer>(Arrays.asList(0, 1, 3, 5, 8, 9, 11, 14, 17, 20, 21, 22, 26, 28, 29, 30, 31, 32, 34, 36, 38, 40, 42, 44, 46, 50, 55, 57, 58, 59, 64, 70, 72, 73, 74, 81, 88, 89)));
...
//	        }
    ...
    public String show(Model model, @RequestParam(value = "id", defaultValue = "0") String id) throws ScriptException {
